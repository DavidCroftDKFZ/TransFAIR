...
public abstract class IdMapping {
   ...
   */
  public HashMap<String, HashMap<String, HashMap<String, String>>> getMappingsCache() {
  ...
  public void setMapping(
    ...
    if (!this.mappingsCache.containsKey(domA)) {
      this.mappingsCache.put(domA, new HashMap<>());
    }
    if (!this.mappingsCache.containsKey(domB)) {
      this.mappingsCache.put(domB, new HashMap<>());
    }
  ...
  public void setMappings(
      @NotNull String domA,
      @NotNull String domB,
      @NotNull ArrayList<String> idsA,
      @NotNull ArrayList<String> idsB)
      throws IllegalArgumentException {
